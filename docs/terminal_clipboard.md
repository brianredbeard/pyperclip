...
**Note:** The `paste()` functionality for these protocols is intentionally disabled in `pyperclip`. Programmatic reading of the clipboard via terminal escape sequences is a significant security risk and is not widely supported by terminal emulators.
...
- **Authoritative Specification:** [XTerm Control Sequences - OSC 52](https://invisible-island.net/xterm/ctlseqs/ctlseqs.html#h3-Operating-System-Commands)
...
- **Authoritative Specification:** [Kitty Clipboard Protocol](https://sw.kovidgoyal.net/kitty/clipboard/#writing-data-to-the-system-clipboard)
